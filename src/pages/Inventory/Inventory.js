...
export default class Inventory extends React.Component {
    ...
    render() {
        ...
        if (this.state.loading === false) {
            data = <TableList
                header={['SIORG', 'Solicitante', 'Descrição', 'Origem', 'Tipo', 'Quantidade', 'Estado', 'Localização', '', '', '']}
        ...
        return (
            <div>
                <Header/>
                <SubHeader title="Almoxarifado"/>

                <Button style={{marginTop: '1%', marginLeft: '1%'}} color="success" onClick={() => {
                    this.handleClick(null)
                }} type="submit">Cadastrar Item</Button>
